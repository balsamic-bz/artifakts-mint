...
const ConnectButton = styled(WalletDialogButton)`color: white; font-weight: bold; border: 3px solid black; border-radius: 3px`;
...
const Home = (props: HomeProps) => {
  ...
  return (
    ...
    <video
      ...
      {wallet && <p>ARTIFAKTS Minted: {itemsRedeemed} / {itemsAvailable-1}</p>}
        ...
        {!wallet ? (
          ...
          >
            {isSoldOut ? (
              ...
              <Countdown
                date={1637427600000}  // JS timestampes are in milliseconds, must have 3 zeros added
